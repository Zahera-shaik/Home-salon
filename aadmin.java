...
import java.sql.*;
import java.io.*;
public class aadmin extends GenericServlet
{
...
if(flag==1)
{
RequestDispatcher rd=req.getRequestDispatcher("ex_admin.html");
rd.forward(req,res);
}
else
{
out.println("<h1>Sorry! roll.no and password details are not found</h1>");
RequestDispatcher rd=req.getRequestDispatcher("aadmin.html");
rd.include(req,res);
}
con.close();
}
